<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10">
                <a style="background-color: green;" href="{{ route('produk.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    + Create produk
                </a>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="border px-6 py- text-center">
                                ...
                                <form action="{{ route('produk.destroy', $item->id) }}" method="POST" class="inline-block">
                                    ...
                                    <button style="background-color: red;" type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 mx-2 rounded inline-block">
                                        Delete
                                    </button>
                                </form>
                            </td>
